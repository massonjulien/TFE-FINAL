    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView style={styles.main}>
            <TouchableOpacity style={styles.advertPicture_container} onPress={() => {}}>
              <Image
                style={styles.image}
                resizeMode = {'contain'}
                source={{uri: 'https://olitot.com/IMG/no-image.jpg'}}
              />
            </TouchableOpacity>
          <Text style={styles.text}>Nom du plat</Text>
          <TextInput
          ...
          />
          <Text style={styles.text}>Nombre de part(s)</Text>
          <TextInput
            maxLength = {2}
            blurOnSubmit = {true}
            keyboardType = 'numeric'
            placeholder = "Nombre de part (Exemple : 4)"
            style = { styles.textInput }
          ...
          <TextInput
            ...
            blurOnSubmit = {true}
            keyboardType = 'numeric'
            placeholder = "Prix par part (Exemple : 4)"
            style = { styles.textInput }
